...
if (isset($_POST['letters4']) && $_POST['letters4'] == True) {
    ...
    $_SESSION['letters'] = 8;
} elseif (isset($_POST['letters?']) && $_POST['letters?'] == True) {
    $_SESSION['letters'] = '?';
}
...
if (isset($_POST['tries4']) && $_POST['tries4'] == True) {
    ...
    $_SESSION['tries'] = 6;
} elseif (isset($_POST['tries!']) && $_POST['tries!'] == True) {
    $_SESSION['tries'] = '!';
}
    ...
    <form method="post">
        <div class="gameRules">
            ...
            <div class="choice">
                ...
                <input type="radio" id="a9" name="letters?"> 
            ...
            <div class="choice less-space-after-choice">
                ...
                <label for="t46" class=rectangle-number-try>6</label>
